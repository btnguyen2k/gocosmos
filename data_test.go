...
func _initDataSmallRU(t *testing.T, testName string, client *RestClient, db, container string, numItem int) {
...
func _initDataLargeRU(t *testing.T, testName string, client *RestClient, db, container string, numItem int) {
	client.DeleteDatabase(db)
...
func _initDataFamliesSmallRU(t *testing.T, testName string, client *RestClient, db, container string) {
	client.DeleteDatabase(db)
	client.CreateDatabase(DatabaseSpec{Id: db, Ru: 400})
	client.CreateCollection(CollectionSpec{
		DbName:           db,
...
func _initDataFamliesLargeRU(t *testing.T, testName string, client *RestClient, db, container string) {
	client.DeleteDatabase(db)
	client.CreateDatabase(DatabaseSpec{Id: db, Ru: 20000})
	client.CreateCollection(CollectionSpec{
		DbName:           db,
...
func _initDataVolcanoSmallRU(t *testing.T, testName string, client *RestClient, db, container string) {
	client.DeleteDatabase(db)
	client.CreateDatabase(DatabaseSpec{Id: db, Ru: 400})
	client.CreateCollection(CollectionSpec{
		DbName:           db,
...
func _initDataVolcanoLargeRU(t *testing.T, testName string, client *RestClient, db, container string) {
	client.DeleteDatabase(db)
	client.CreateDatabase(DatabaseSpec{Id: db, Ru: 20000})
	client.CreateCollection(CollectionSpec{
		DbName:           db,
